"""Canonical assembly for one TCN temporal forecast Trainer."""
...
def build_solver(config=None, *, resource_context=None, component_overrides=None):
    ...
    builder = overrides.get("trainer_builder") or build_temporal_tcn_forecast_trainer
    ...
    trainer_kwargs.setdefault("run_name", "temporal_tcn_compare")
