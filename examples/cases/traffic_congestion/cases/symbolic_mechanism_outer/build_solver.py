...
@dataclass
class SymbolicMechanismOuterBridge:
    """Standard Case bridge for the historical Work-CI mechanism reconstruction script."""

    resource_context: Mapping[str, Any] = field(default_factory=dict)
    default_args: Sequence[str] = ()
    case_kind: str = "mechanism"

    @property
    def problem(self) -> str:
        return "traffic_symbolic_mechanism_reconstruction"
    ...
    def pipeline(self) -> str:
        return "legacy_nowcasting_symbolic_pipeline"
