...
def build_mf_trainer(
    ...
    *,
    ...
    from pipeline.representation.mf_representation import MFRepresentation

    n_users, n_items = R.shape

    problem = MatrixFactorizationProblem(R, mask, reg_weight=reg_weight, name="mf_problem")
    representation = MFRepresentation(n_users, n_items, k=k, init_scale=0.05, nmf=nmf, name="mf_rep")
